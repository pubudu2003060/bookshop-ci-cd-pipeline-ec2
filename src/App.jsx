...
export default function BookshopHomepage() {
  ...
  const categories = [
    ...
    "Romance", "Biography", "History", "Children's"
  ];
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                <h1 className="text-2xl font-bold text-indigo-700">BookStore</h1>
              </div>
              <div className="hidden md:ml-6 md:flex md:space-x-8">
                ...
                <a href="#" className="text-gray-500 hover:text-indigo-600 px-3 py-2 text-sm font-medium flex items-center">
          ...
          <div className="py-16 md:py-24 flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 text-center md:text-left mb-8 md:mb-0">
              ...
              <p className="mt-4 text-lg text-indigo-100 max-w-lg mx-auto md:mx-0">
                From bestsellers to hidden gems, find stories that will transport you to new worlds and perspectives.
              </p>
              <div className="mt-8 flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                <a href="#" className="px-8 py-3 bg-white text-indigo-700 font-medium rounded-full shadow hover:bg-indigo-50 transition duration-300">
                  Explore Books
                </a>
                <a href="#" className="px-8 py-3 bg-transparent text-white border border-white font-medium rounded-full hover:bg-white hover:bg-opacity-10 transition duration-300">
                  Join Book Club
                </a>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        <div className="flex justify-between items-center mb-8">
          ...
          <a href="#" className="text-indigo-600 hover:text-indigo-800 flex items-center text-sm font-medium">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {featuredBooks.map((book) => (
            <div key={book.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
              <div className="relative">
                <img 
                  src={book.cover} 
                  alt={book.title} 
              ...
              <div className="p-4">
                ...
                <div className="flex items-center mt-2">
                  ...
                  <span className="ml-auto font-bold text-indigo-700">{book.price}</span>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="hover:text-white transition duration-300">Bestsellers</a></li>
                <li><a href="#" className="hover:text-white transition duration-300">New Releases</a></li>
                <li><a href="#" className="hover:text-white transition duration-300">Upcoming</a></li>
                <li><a href="#" className="hover:text-white transition duration-300">Bargain Books</a></li>
              </ul>
            </div>
            <div>
